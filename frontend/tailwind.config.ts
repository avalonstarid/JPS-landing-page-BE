...
export default <Partial<Config>>{
  ...
  plugins: [
    require('./metronic/core/plugins/plugin'),
    require('./metronic/core/plugins/components/theme'),
    require('./metronic/core/plugins/components/breakpoints'),
    require('./metronic/core/plugins/components/typography'),
    require('./metronic/core/plugins/components/menu'),
    require('./metronic/core/plugins/components/dropdown'),
    require('./metronic/core/plugins/components/accordion'),
    require('./metronic/core/plugins/components/input'),
    require('./metronic/core/plugins/components/input-group'),
    require('./metronic/core/plugins/components/select'),
    require('./metronic/core/plugins/components/textarea'),
    require('./metronic/core/plugins/components/file-input'),
    require('./metronic/core/plugins/components/switch'),
    require('./metronic/core/plugins/components/checkbox'),
    require('./metronic/core/plugins/components/radio'),
    require('./metronic/core/plugins/components/range'),
    require('./metronic/core/plugins/components/container'),
    require('./metronic/core/plugins/components/image-input'),
    require('./metronic/core/plugins/components/modal'),
    require('./metronic/core/plugins/components/drawer'),
    require('./metronic/core/plugins/components/tooltip'),
    require('./metronic/core/plugins/components/popover'),
    require('./metronic/core/plugins/components/btn'),
    require('./metronic/core/plugins/components/btn-group'),
    require('./metronic/core/plugins/components/tabs'),
    require('./metronic/core/plugins/components/pagination'),
    require('./metronic/core/plugins/components/card'),
    require('./metronic/core/plugins/components/table'),
    require('./metronic/core/plugins/components/badge'),
