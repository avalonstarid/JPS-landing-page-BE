  ...
  <div class="card-grid card">
    ...
    <div class="card-body">
      ...
      >
        ...
        <el-table-column prop="question.id" label="Pertanyaan (ID)" />
        <el-table-column prop="question.en" label="Pertanyaan (EN)" />
...
const basePermission = 'faq'

const route = useRoute()
const { faqs, getFaqs, destroyFaq, bulkDestroyFaq, loading, state } = useFaqs()
...
const deleteSelectedData = () => {
  ElMessageBox.confirm(
    ...
    .then(async () => {
      await bulkDestroyFaq({ data: selectedData.value })
      await getFaqs()
    })
    .catch(() => {})
}
