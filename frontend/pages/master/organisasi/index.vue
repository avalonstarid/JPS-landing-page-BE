  ...
  <div class="card-grid card">
    <div class="flex-wrap gap-2 py-5 card-header">
      <div v-if="selectedData.length === 0">
        <NuxtLink
          ...
          :to="{ name: 'master-organisasi-create' }"
        >
    ...
    <div class="card-body">
      ...
      >
        ...
        <el-table-column prop="name.id" label="Nama" />
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item
                    ...
                    @click="$router.push(`/master/organisasi/${row.id}`)"
                  >
...
definePageMeta({
  ...
  authorize: ['organisasi_read'],
})
const basePermission = 'organisasi'
...
const deleteSelectedData = () => {
  ElMessageBox.confirm(
    ...
    .then(async () => {
      await bulkDestroyOrganization({ data: selectedData.value })
      await getOrganizations()
    })
    .catch(() => {})
}
