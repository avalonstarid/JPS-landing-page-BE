<template>
  <div class="image-input size-24">
    ...
    <span id="image_input_tooltip" class="tooltip">Click to remove</span>
    <div
      class="bg-center border-2 rounded-full image-input-placeholder border-success"
      :class="{ '!border-gray-300': !previewImage }"
      :style="`background-image: url(${previewImage ?? '/media/avatars/blank.png'})`"
...
const emit = defineEmits(['change', 'click', 'remove'])
