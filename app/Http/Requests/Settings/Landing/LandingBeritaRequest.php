...
class LandingBeritaRequest extends BaseApiRequest
{
	...
	public function attributes(): array
	{
		return [
			// News
			'news_subtitle.en' => 'Berita Subtitle (Bahasa Inggris)',
			'news_subtitle.id' => 'Berita Subtitle (Bahasa Indonesia)',
			'news_title.en' => 'Berita Title (Bahasa Inggris)',
			'news_title.id' => 'Berita Title (Bahasa Indonesia)',
