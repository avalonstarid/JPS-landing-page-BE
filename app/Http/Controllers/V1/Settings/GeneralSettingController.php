...
class GeneralSettingController extends Controller
{
	...
	/**
	 * Update Landing Page Pengumuman
	 *
	 * @param LandingPengumumanRequest $request
	 *
	 * @return JsonResponse
	 * @throws Throwable
	 */
	public function landingPengumuman(LandingPengumumanRequest $request)
	{
		try {
			$this->authorize('update_landing', Setting::class);
	...
	/**
	 * Update Landing Page Produk
	 *
	 * @param LandingProdukRequest $request
	 *
	 * @return JsonResponse
	 * @throws Throwable
	 */
	public function landingProduk(LandingProdukRequest $request)
	{
		try {
			$this->authorize('update_landing', Setting::class);
